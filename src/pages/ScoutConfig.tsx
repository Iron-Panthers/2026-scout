...
export default function ScoutConfig() {
  ...
  return (
    <div
      className="min-h-screen flex flex-col my-5"
      style={{ padding: "20px" }}
    >
      {/* Back Button */}
      ...
      <div className="flex w-full max-w-sm flex-col gap-6">
        <Tabs value={activeTab} onValueChange={setActiveTab} className="">
          ...
          <TabsList className="fixed flex h-10 left-0 right-0 w-full text-center bottom-0 bg-background border-t border-border z-50">
            <TabsTrigger
              value="config"
              className="flex-1 py-2 data-[state=active]:border-t-2 data-[state=active]:border-primary bg-background hover:bg-accent hover:text-accent-foreground mx-1"
            >
              Settings
            </TabsTrigger>
            <TabsTrigger
